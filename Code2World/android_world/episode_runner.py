...
class EpisodeResult:
  ...
  step_data: dict[str, Any]  # 每一步的环境和智能体数据
  env_reward: Optional[float] = None  # 环境奖励
  aux_data: Optional[dict[str, Any]] = None  # 辅助数据 
...
# 将字典的列表（DOL）转换为列表的字典（LOD），是_transpose_lod_to_dol的逆操作。
